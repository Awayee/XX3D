...
#define MATH_GENERIC template<typename T>
    ...
    MATH_GENERIC Vector3<T> Vector3<T>::Abs(const Vector3<T>& v) {
        return { Math::Abs(v.x), Math::Abs(v.y), Math::Abs(v.z) };
    }

    MATH_GENERIC bool Vector3<T>::AllLess(const Vector3<T>& v0, const Vector3<T>& v1) {
        return v0.x < v1.x && v0.y < v1.y && v0.z < v1.z;
    }

    MATH_GENERIC bool Vector3<T>::AllLessOrEqual(const Vector3<T>& v0, const Vector3<T>& v1) {
        return v0.x <= v1.x&& v0.y <= v1.y&& v0.z <= v1.z;
    }

    MATH_GENERIC bool Vector3<T>::AllGreater(const Vector3<T>& v0, const Vector3<T>& v1) {
        return v0.x > v1.x && v0.y > v1.y && v0.z > v1.z;
    }

    MATH_GENERIC bool Vector3<T>::AllGreaterOrEqual(const Vector3<T>& v0, const Vector3<T>& v1) {
        return v0.x >= v1.x && v0.y >= v1.y && v0.z >= v1.z;
    }
