...
class ExampleShader : public Render::GlobalShader {
	...
	SHADER_PERMUTATION_SWITCH(MACRO_NAME0, false);
	SHADER_PERMUTATION_SWITCH(MACRO_NAME1, false, MACRO_NAME0);
	SHADER_PERMUTATION_INT(MACRO_NAME2, 0, 8, 1, MACRO_NAME1);
	SHADER_PERMUTATION_END
	// or
	// SHADER_PERMUTATION_EMPTY();

	BEGIN_SHADER_BINDING
	// SHADER_BINDING_SET(0)
	SHADER_BINDING(0, UniformBuffer, BufferParam, 1)
	SHADER_BINDING(1, Texture, TexturParam, 1)
	SHADER_BINDING_SET(1)
	SHADER_BINDING(0, UniformBuffer, BufferParamAtSet2, 1)
	SHADER_BINDING(1, Texture, TExtureParamAtSet2, 1)
	SHADER_BINDING(2, Sampler, LinearSampler, 1)
	END_SHADER_BINDING
	// or
