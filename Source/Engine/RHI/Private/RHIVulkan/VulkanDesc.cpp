...
inline size_t GetLayoutHash(const RHIShaderBindingLayout& bindingLayout) {
...
VkDescriptorSetLayout VulkanDSMgr::GetLayoutHandle(const RHIShaderBindingLayout& bindingLayout) {
	...
	for(uint32 i=0; i<bindingCount; ++i) {
		...
		bindings[i].descriptorType = ToVkDescriptorType(bindingLayout[i].Type);
